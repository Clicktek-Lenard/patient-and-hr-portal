module.exports = [
"[project]/.next-internal/server/app/api/share-links/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/share-links/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const links = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].portalShareLink.findMany({
            where: {
...
async function POST(req) {
    try {
        ...
        const link = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].portalShareLink.create({
            data: {
                userId: session.user.id,
                queueCode,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6c4e270a._.js.map