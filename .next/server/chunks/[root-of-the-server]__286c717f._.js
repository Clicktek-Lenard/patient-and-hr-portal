module.exports = [
"[project]/.next-internal/server/app/api/hr/employees/[code]/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$node_modules$2f40$auth$2f$core$2f$providers$2f$credentials$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
            ...
            async authorize (credentials) {
                ...
                if (loginType === "hr") {
                    ...
                    const passwordMatches = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compare(password, user.password);
                    if (!passwordMatches) {
                        throw new Error("Invalid email or password");
                    }
                    // Clear rate limit on success
...
"[project]/src/app/api/hr/employees/[code]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_req, { params }) {
    ...
    const patient = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2d$cms$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cmsPrisma"].cmsPatient.findUnique({
        where: {
            code
        },
        select: {
    ...
    if (!patient) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Not found"
    }, {
        status: 404
    });
    // Fetch queues without inline relations to avoid orphaned-FK errors
    const rawVisits = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2d$cms$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cmsPrisma"].cmsQueue.findMany({
        where: {
    ...
    const transactions = queueBigIds.length ? await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2d$cms$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cmsPrisma"].cmsTransaction.findMany({
        where: {
            idQueue: {
                in: queueBigIds
            },
    ...
    const vitals = queueIntIds.length ? await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2d$cms$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cmsPrisma"].cmsVitalSign.findMany({
        where: {
            queueId: {
                in: queueIntIds
            }
    ...
    const vitalsMap = new Map(vitals.map((v)=>[
            String(v.queueId),
            v
        ]));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__286c717f._.js.map