module.exports = [
"[project]/.next-internal/server/app/api/hr/wellness/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/hr/wellness/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const totalPatients = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2d$cms$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cmsPrisma"].cmsPatient.count({
            where: {
                isActive: 1
            }
        });
        // For each month: count PE transactions (APE/annual physical)
        const peByMonth = await Promise.all(months.map(async (m)=>{
            const count = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2d$cms$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cmsPrisma"].cmsTransaction.count({
                where: {
                    date: {
                        gte: m.start,
                        lte: m.end
        ...
        const hypertensionByMonth = await Promise.all(months.map(async (m)=>{
            const count = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2d$cms$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cmsPrisma"].cmsVitalSign.count({
                where: {
                    createdAt: {
                        gte: m.start,
                        lte: m.end
            ...
            const totalVitals = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2d$cms$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cmsPrisma"].cmsVitalSign.count({
                where: {
                    createdAt: {
                        gte: m.start,
                        lte: m.end
        ...
        const preHypertensionByMonth = await Promise.all(months.map(async (m)=>{
            const count = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2d$cms$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cmsPrisma"].cmsVitalSign.count({
                where: {
                    createdAt: {
                        gte: m.start,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__adc20a18._.js.map