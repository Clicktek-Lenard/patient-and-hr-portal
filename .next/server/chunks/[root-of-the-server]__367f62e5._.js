module.exports = [
"[project]/.next-internal/server/app/api/trends/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/trends/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        if (!patientCode) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            data: []
        });
        const cmsPatient = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2d$cms$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cmsPrisma"].cmsPatient.findUnique({
            where: {
        ...
        if (!cmsPatient) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            data: []
        });
        // Trends from transactions — track service amounts over time per test type
        const transactions = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2d$cms$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cmsPrisma"].cmsTransaction.findMany({
            where: {
                queue: {
        ...
        for (const tx of transactions){
            ...
            const dateStr = tx.date ? new Date(tx.date).toISOString().split("T")[0] : new Date(tx.queue.dateTime).toISOString().split("T")[0];
        ...
        const series = Object.entries(seriesMap).filter(([, points])=>points.length >= 1).map(([name, points])=>({
                name,
                points: points.sort((a, b)=>a.date.localeCompare(b.date)),
                unit: "PHP",
                normalRange: ""
            })).sort((a, b)=>b.points.length - a.points.length).slice(0, 20);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__367f62e5._.js.map