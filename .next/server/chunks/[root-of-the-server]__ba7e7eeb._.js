...
async function GET(req) {
    ...
    if (gender) andClauses.push({
        gender: {
            equals: gender,
            mode: "insensitive"
        }
    });
    if (active !== "") andClauses.push({
    ...
    const [total, patients] = await Promise.all([
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2d$cms$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cmsPrisma"].cmsPatient.count({
            where
        }),
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2d$cms$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cmsPrisma"].cmsPatient.findMany({
            where,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ba7e7eeb._.js.map