...
async function GET() {
    try {
        ...
        const appointments = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].portalAppointment.findMany({
            where: {
...
async function POST(req) {
    try {
        ...
        const appointment = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].portalAppointment.create({
            data: {
                userId: session.user.id,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e8d5da37._.js.map