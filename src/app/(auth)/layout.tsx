        ...
        <div className="relative z-10 flex flex-col h-full px-12 py-12">
          ...
          <div className="flex-1 flex flex-col justify-center">
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                { icon: "🧪", label: "Lab & Imaging Results" },
                { icon: "📡", label: "Real-time Queue" },
                { icon: "💗", label: "Vital Signs History" },
                { icon: "🧾", label: "Payments & Receipts" },
              ].map((f) => (
                <div key={f.label} className="flex items-center gap-2.5 rounded-xl border px-3 py-2.5"
